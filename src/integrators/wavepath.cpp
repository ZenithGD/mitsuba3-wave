...
class WavePathIntegrator : public MonteCarloIntegrator<Float, Spectrum> {
public:
    MI_IMPORT_BASE(MonteCarloIntegrator, m_max_depth, m_rr_depth, m_hide_emitters)
    MI_IMPORT_TYPES(Scene, Sampler, Medium, Emitter, EmitterPtr, BSDF, BSDFPtr)

    WavePathIntegrator(const Properties &props) : Base(props) { }
    ...
    std::string to_string() const override {
        return tfm::format("WavePathIntegrator[\n"
            "  max_depth = %u,\n"
            "  rr_depth = %u\n"
...
MI_IMPLEMENT_CLASS_VARIANT(WavePathIntegrator, MonteCarloIntegrator)
MI_EXPORT_PLUGIN(WavePathIntegrator, "Generalized Ray Path Tracer integrator");
