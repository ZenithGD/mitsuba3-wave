...
MI_PY_EXPORT(Coherence) {
    ...
    auto it = py::class_<Coherence3f>(m, "Coherence3f", D(Coherence))
        ...
        .def("inv_coherence_matrix",py::overload_cast<Float>(&Coherence3f::inv_coherence_matrix, py::const_), 
            "k"_a, D(Coherence, inv_coherence_matrix))
        .def("inv_coherence_matrix",py::overload_cast<>(&Coherence3f::inv_coherence_matrix, py::const_), 
            D(Coherence, inv_coherence_matrix, 2))
        .def("inv_coherence_det",py::overload_cast<Float>(&Coherence3f::inv_coherence_det, py::const_), 
            "k"_a, D(Coherence, inv_coherence_det))
        .def("inv_coherence_det",py::overload_cast<>(&Coherence3f::inv_coherence_det, py::const_), 
...
MI_PY_EXPORT(PLTInteraction){
    ...
    auto it = py::class_<PLTInteraction3f>(m, "PLTInteraction3f", D(PLTInteraction))
        // Members
        .def_field(PLTInteraction3f, sp_coherence, D(PLTInteraction, sp_coherence))
        .def_field(PLTInteraction3f, t, D(PLTInteraction, t))
        // Methods
        .def(py::init<>(), D(PLTInteraction, PLTInteraction))
        .def(py::init<const PLTInteraction3f &>(), "Copy constructor")
